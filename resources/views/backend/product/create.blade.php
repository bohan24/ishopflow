...
<div class="container-fluid content" style="margin-top: 120px;">
    ...
    <form style="background-color:white;box-shadow: 0 2px 6px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" id="addForm" name="addForm" method="post" enctype="multipart/form-data" action="{{url('/backend/add')}}">
                ...
                <tr>
                    <td>
                        <div class="form-group row {{ (($errors->has('Name')) ? ' error' : '') }}">
                            ...
                            <input type="text" class="col-md-10 form-control" id="Name" name="Name" value="{{old('Name')}}" placeholder="請輸入名稱，必填" />
                        </div>        
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td colspan="2">
                        <div class="form-group row mb-4 {{ (($errors->has('o_price')) ? ' error' : '') }}">
                            ...
                            <input type="text" class="col-md-7 form-control" id="o_price" name="o_price" value="{{old('o_price')}}" placeholder="請輸入最低價，必填" />
                        </div>
                    </td>
                    <td>
                        <div class="form-group row mb-4 justify-content-end {{ (($errors->has('price')) ? ' error' : '') }}">
                            ...
                            <input type="text" class="col-md-7 form-control" id="price" name="price" value="{{old('price')==''?0:old('price1')}}" placeholder="請輸入最低特價，預設為0" />
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn_group ">
                    <button type="button" class="btn btn-secondary " onclick="afterSubmit('0')">在新增一筆</button>
